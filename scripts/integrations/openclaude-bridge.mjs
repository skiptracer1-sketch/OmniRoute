...
export function buildOpenClaudeEnv(source = process.env) {
  return {
    ...
    OPENAI_BASE_URL: source.OPENAI_BASE_URL || DEFAULT_BASE_URL,
    OPENAI_MODEL: source.OPENAI_MODEL || DEFAULT_MODEL,
    OPENAI_API_KEY: source.OPENAI_API_KEY || DEFAULT_API_KEY,
  };
}
